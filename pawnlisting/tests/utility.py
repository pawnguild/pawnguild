...
class UtilityTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.ps4_pawn = PS4Pawn.objects.create(**self.generate_ps4_pawn_data(self.test_args["ps4_pawn_name"]))
        self.ps3_pawn = PS3Pawn.objects.create(**self.generate_ps3_pawn_data(self.test_args["ps3_pawn_name"]))
    ...
    def generate_ps3_pawn_data(self, name, psn="MahPSN3", version="Dark Arisen", **kwargs):
